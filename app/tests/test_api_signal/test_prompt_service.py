"""
Test file để demo PromptService - chạy từ thư mục tests
"""
import sys
import os
...
def test_prompt_service():
    """Test function để demo PromptService"""
    ...
    # Test 2: Check prompt functions
    print("\n2. Checking prompt functions...")
    try:
        # Test if prompt_signal_analyst function is available
        prompt_function = prompt_service.get_prompt_function('prompt_signal_analyst')
        
        if prompt_function is not None:
            print("   [OK] prompt_signal_analyst function found!")
        else:
            print("   [ERROR] prompt_signal_analyst function not found!")
            return
    except Exception as e:
        print(f"   [ERROR] Error checking prompt functions: {e}")
        return
    
    # Test 3: Create prompt
    print("\n3. Creating signal analyst prompt...")
    try:
        ...
        content_preview = prompt_string[:300] + "..."
        ...
        filename = f"{output_dir}/prompt_signal_analyst_{timestamp}.txt"
